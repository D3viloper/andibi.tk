...
$config_navbar_content = array(
                                ...
                                array("dropdown" => "true", "text" => "Tools", "dropdown_idf" => "tools", "elements" => array(array("text" => "Datalist-Test", "page_idf" => "datalisttest"),
																																	  ...
																																	  array("text" => "YouTube-Playlist Gesamtspielzeit", "page_idf" => "yt")))
                            );
$config_global_meldung = array("activated" => "false", "bell_count" => "1", "level" => "success", "message" => '<strong>Willkommen bei ANDIBI.TK!</strong><br> Das neue Design, welches das  <strong><a href="http://www.google.com/design/" target="_blank">Material-Design</a></strong> von Google benutzt, ist endlich online. Bitte <strong><a href="'.$root.'contact.php">melde auftretende Fehler</a></strong>. Den Code kannst du <strong><a href="https://github.com/Brawl345/andibi.tk/" target="_blank">auf GitHub betrachten</a></strong>.');
?>
